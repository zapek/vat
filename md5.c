...
void ASM SAVEDS VAT_CalcMD5( __reg( a0, char *in ), __reg( d0, int inlen ), __reg( a1, char *out ) )
{
	MD5_CTX ctx;
...
void ASM SAVEDS VAT_MD5Init( __reg( a0, APTR ctx ) )
{
	DB( ( "called\n" ) );
...
void ASM SAVEDS VAT_MD5Final( __reg( a0, APTR out ), __reg( a1, APTR ctx ) )
{
	DB( ( "called\n" ) );
...
void ASM SAVEDS VAT_MD5Update( __reg( a0, APTR ctx ), __reg( a1, APTR data ), __reg( d0, int datalen ) )
{
	DB( ( "called\n" ) );
